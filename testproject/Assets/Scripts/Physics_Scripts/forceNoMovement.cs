...
public class forceNoMovement : MonoBehaviour{
    ...
    void FixedUpdate() { // Fixed update for physics 
        ...
        force = CalculateForce(position1, position2, radius1, radius2, epsilon, sigma); // This is Van der Waal's force

        // Apply the force to the particle
        //force = force * 10f; //commented out for magnitude
        force = force * 0.005f;
        //Debug.Log("Value of force calculation: " + force);
        //valueText.text = force.ToString();
